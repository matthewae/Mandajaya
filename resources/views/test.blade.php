            ...
            <div class="flex flex-wrap justify-center">
                <div class="w-full md:w-1/3 p-4">
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <button class="w-full text-left focus:outline-none" onclick="toggleAccordion('goal1')">
                            <div class="flex justify-between items-center">
                                <h3 class="text-xl font-bold mb-2">Excellence in Quality</h3>
                                <i class="fas fa-chevron-down"></i>
                            </div>
                        </button>
                        <div id="goal1" class="accordion-content mt-4">
                ...
                <div class="w-full md:w-1/3 p-4">
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <button class="w-full text-left focus:outline-none" onclick="toggleAccordion('goal2')">
                            <div class="flex justify-between items-center">
                                <h3 class="text-xl font-bold mb-2">Client Relationships</h3>
                                <i class="fas fa-chevron-down"></i>
                            </div>
                        </button>
                        <div id="goal2" class="accordion-content mt-4">
                ...
                <div class="w-full md:w-1/3 p-4">
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <button class="w-full text-left focus:outline-none" onclick="toggleAccordion('goal3')">
                            <div class="flex justify-between items-center">
                                <h3 class="text-xl font-bold mb-2">Innovation and Improvement</h3>
                                <i class="fas fa-chevron-down"></i>
                            </div>
                        </button>
                        <div id="goal3" class="accordion-content mt-4">
